        ...
        <nav aria-label="Main navigation" className="flex items-center gap-1">
          {isLoggedIn ? (
            ...
            <>
              ...
              <Link
                href="/features"
                className="hidden sm:inline-flex px-3 py-1.5 text-sm text-gray-800 hover:text-gray-900 transition-colors"
              >
                Features
              </Link>
              <Link
              ...
              <Link
                href="/signup"
                className="ml-2 px-4 py-2 text-sm font-medium bg-violet-600 hover:bg-violet-500 text-white rounded-lg transition-colors"
              >
                Signup
              </Link>
      ...
      {menuOpen && !isLoggedIn && (
        <div className="sm:hidden absolute top-full left-0 right-0 bg-white border-t border-gray-200 px-4 py-3 flex flex-col gap-1 shadow-lg">
          <Link
            ...
            className="px-4 py-2.5 text-sm text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors"
          >
            Features
          </Link>
          <Link
