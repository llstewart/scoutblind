...
export function SavedAnalysesPanel({
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed right-0 top-0 h-full w-full max-w-md bg-zinc-900 border-l border-zinc-800 z-50 shadow-2xl flex flex-col">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-center px-6">
              ...
              <h3 className="text-zinc-300 font-medium mb-1">No saved analyses</h3>
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          <span className="text-white font-medium truncate">{search.niche}</span>
                          {isActive && (
        ...
        {savedSearches.length > 0 && (
          <div className="border-t border-zinc-800 p-4">
            {showClearConfirm ? (
              <div className="flex items-center gap-2">
                <span className="text-sm text-zinc-400 flex-1">Clear all history?</span>
                <button
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2 text-sm text-zinc-400 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-colors"
              >
