        ...
        <div className="space-y-8 text-sm text-gray-600 leading-relaxed">
          <section>
            ...
            <ul className="list-disc list-inside space-y-1.5 text-gray-500">
              ...
              <li><span className="text-gray-600">Business data:</span> publicly available Google Business Profile data retrieved through your searches</li>
              <li><span className="text-gray-600">Usage data:</span> credit usage, search history, and feature interactions</li>
              <li><span className="text-gray-600">Payment information:</span> processed securely by Stripe — we do not store your card details</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1.5 text-gray-500">
              ...
              <li><span className="text-gray-600">Google / Outscraper:</span> retrieving publicly available Google Business Profile data</li>
              <li><span className="text-gray-600">Vercel:</span> application hosting and edge functions</li>
              <li><span className="text-gray-600">Upstash:</span> rate limiting via Redis</li>
            </ul>
            <p className="mt-3">Each of these services has their own privacy policy governing their handling of data.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">4. Cookies &amp; Local Storage</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">5. Data Retention &amp; Deletion</h2>
            <p className="mb-3">
