...
export const metadata: Metadata = {
  title: 'FAQ',
  description: 'Frequently asked questions about Packleads. Learn about credits, GBP signals, pricing, data accuracy, and more.',
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Packleads employs high-performance algorithms that integrate real-time GBP data with the same analytical methodologies used by industry experts. Our system processes complex signals—like review trends and response metrics—through a technical lens to provide consistent, actionable intelligence.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Packleads offers a free tier (5 credits), a Starter plan ($29/mo for 50 credits), and a Pro plan ($79/mo for 200 credits). All plans include full signal analysis, CSV export, and search history. Subscriptions are billed monthly via Stripe and can be canceled anytime.',
      },
    },
    {
      '@type': 'Question',
