        ...
        <div className="bg-white dark:bg-card rounded-xl elevation-1 overflow-hidden">
          ...
          {[...Array(6)].map((_, i) => (
            <div key={i} className="flex items-center gap-4 px-5 py-3.5 border-b border-gray-100">
              <div className="h-4 w-4 bg-gray-100 rounded-lg animate-pulse" />
              ...
              <div className="flex-1 space-y-1.5">
                ...
                <div className="h-3 w-56 bg-gray-50 rounded-lg animate-pulse" />
              </div>
              <div className="h-9 w-9 bg-gray-100 rounded-full animate-pulse" />
              <div className="h-4 w-14 bg-gray-50 rounded-lg animate-pulse" />
            </div>
          ))}
        </div>
      </main>
